...
const MainInfo = ({
  ...
  return (
    <section
    className={`w-full flex flex-col h-auto md:h-[720px] ${
  ...
  >
    ...
    >
      <div>
        ...
        {buttonText && (
          <button className="font-lato font-[400] text-[14px] mt-8 rounded-full px-4 py-4 bg-[#171819] md:min-w-[246px] w-full md:max-w-60 text-white hover:bg-gray-800 transition">
            {buttonText}
          </button>
        )}
      </div>
