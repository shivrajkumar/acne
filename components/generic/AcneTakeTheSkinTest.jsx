    ...
    <div>
      <div className="block xl:hidden lg:hidden md:hidden">
        <a
          href={redirectTo}
          onClick={handleClick}
          className={`flex ${hairTestButtonColor[variant]}  ${hairTestButtonColor[size]}  ${hairTestButtonColor[deskSize]} font-[400] mt-4 items-center justify-center font-lato rounded-[1000px] uppercase cursor-pointer leading-[24px] py-[16px] `}
          id={hairTestId}
        >
      ...
      <div className="hidden xl:flex lg:flex md:flex justify-start ">
        <a
          href={redirectTo}
          onClick={handleClick}
          className={`flex ${hairTestButtonColor[variant]} justify-center items-center ${hairTestButtonColor[deskSize]}  font-lato font-[400] rounded-[1000px] uppercase cursor-pointer leading-[24px] -tracking-[1%] py-[16px]`}
          id={hairTestId}
        >
