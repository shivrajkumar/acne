                ...
                >
                  ...
                  >
                    <>
                      ...
                      <span className="font-[500] text-[14px] font-sophiaPro text-Primary/900 hidden sm:block md:block lg:block xl:block uppercase ">
                        Back
                      </span>
                    </>
                  </button>
          ...
          <div>
            {currentQuestion && (
              <button
                ...
                id="exit_button_d"
              >
                <div className="font-[400] text-[14px] font-sophiaPro text-Primary/900 hidden sm:block md:block lg:block xl:block uppercase">
                  Exit
                </div>
