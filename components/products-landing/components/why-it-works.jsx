...
const MagnesiumSkinCombo = () => {
  ...
  const Box = ({ title, items }) => (
    <div className="border border-black w-[200px] md:w-[350px] min-h-[360px] md:min-h-[400px]">
      {/* Make \n respected */}
      <div className="bg-[#A6653D] text-white text-[18px] md:text-2xl font-normal text-center md:text-left py-4 px-4 whitespace-pre-line">
        {title}
      </div>
  ...
  return (
    <div className="w-full px-4 md:px-12 py-12">
      ...
      <div className="text-sm leading-relaxed md:text-[28px] font-normal">
        At Clear Ritual, we target the real acne triggers inside the body while
        supporting your skin from the outside. That’s what makes our approach
        different, and long-term.
      </div>
