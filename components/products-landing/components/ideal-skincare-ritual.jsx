      ...
      <div className="flex flex-col md:flex-row items-start md:items-start justify-between md:px-28 md:gap-10">
        <div className="md:w-1/2">
          ...
          <p className="text-[#5c656d] text-[14px] md:text-2xl leading-relaxed md:w-5/6">
            Whether you’re dealing with stubborn acne, looking to minimize fine lines and wrinkles, or just want to upgrade your regimen, Hers has quality, dermatologist-trusted products you’ll love.
          </p>
        </div>

        <ul className="md:w-1/2 flex flex-col gap-6 mt-5">
          {features.map((feature, idx) => (
            <li key={idx} className="flex items-center text-[#1a232b] text-[14px] md:text-2xl">
