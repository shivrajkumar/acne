    ...
    <>
      ...
      <div className="flex flex-col w-full pt-6 sm:pt-8 px-4 sm:px-6 max-w-screen-xl mx-auto">
        ...
        <div className="fixed bottom-0 left-0 right-0 md:left-auto md:right-4 z-10 flex justify-center md:justify-end pb-8 pt-4 bg-gradient-to-t from-white via-white to-transparent md:bg-transparent">
          <button
            type="submit"
            className={`w-[80%] md:w-auto px-8 py-3 font-[400] font-sophiaPro text-white rounded-full transition-all duration-200 shadow-sm flex items-center justify-center gap-2 ${
