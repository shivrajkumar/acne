...
export default function FivePillars({ data }) {
  const listItems = data?.list_items || [
    "Clinical Proven Skincare",
    "Rx Acne Treatments",
    "Personalised Herbal Skin Food",
    "Dermatologist Led Diagnosis and Plans",
    "Skin Coach Support"
  ];
      ...
      <div className="bg-[#F9F9F5] rounded-[32px] overflow-hidden flex flex-col md:flex-row min-h-[600px]">
        ...
        <div className="w-full md:w-1/2 py-8 px-6 md:p-16 flex flex-col justify-center lg:gap-20">
          <div>
            ...
            {data?.title || "Our Five Pillars, to ensure you see results - that last."}
          </h2>
