    ...
    <div className="flex justify-center">
      <div className="px-4 pb-14 lg:w-[65%] lg:px-0 mt-20">
        ...
        <p className="font-sophiaPro text-[17px]">
          ...
          practices in relation to collection, use, maintain, protect and
        ...
        <div className="flex pl-4">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            particular, the Indian Contract Act, 1872, and have read, understood
            and agreed to the practices and policies outlined in this Privacy
            Policy and agree to be bound by the Privacy Policy. If you disclose
        ...
        <div className="flex pl-4">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            continued use of the Services or the Platform, following any such
            amendments to the Privacy Policy, will be deemed as an implicit
        ...
        <p className="font-sophiaPro text-[17px] pl-8">
          ...
          person and could be used to identify that specific person whether from
          that data, or from the data and other information that we have, or is
          likely to have access to. We do not consider personal information to
          include information that has been made anonymous or aggregated so that
          it can no longer be used to identify a specific person, whether in
          combination with other information or otherwise. Personal information
          can include, but not be limited to, information such as your name,
          email address, contact number (cellular and landline), educational
          qualification(s), occupation, date of birth, marital status, monthly
          income, city and state of residence, marital status, health
          information. number of children, employer details, Aadhaar number,
          PAN, social security and tax identification numbers, and
          post-qualification or work experience among other things; and/or (ii)
          Information about your internet connection, the equipment you use to
          access our Services and your usage details. Given below are the types
          of information that we may collect:
        </p>
        <br />
        <div className="pl-4 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            as phone number, name, age, gender, geographical address and email
            address. We may verify your phone number or email address with the
            ...
            follow, ordering details and history, favourite categories, special
            ...
            accessible areas of our Services or transmitted to other users of
            our Services or third parties (hereinafter collectively referred to
            as “User Contributions”). Your User Contributions are posted on and
            transmitted to others at your own risk. Please be aware that no
        ...
        <div className="pl-4 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            third parties registered on the Platform and add it to our account
            information.
          </p>
        </div>
        <br />
        ...
        <div className="pl-4 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            recall information previously indicated or submitted by you. Most
            browsers/mobile settings allow you to control cookies, including
            whether or not to accept them and how to remove them. You may set
            most browsers/mobile application to notify you if you receive a
            cookie, or you may choose to block cookies with your browser/mobile
            applications. Tracking technologies may record information such as
        ...
        <div className="pl-4 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            personal and overall experience some of the tools are used therein.
            ...
            how third parties place cookies on your computer. For example, third
            party websites to which a link points may set cookies on your
            computer.
          </p>
        </div>{" "}
        <br />
        ...
        <div className="pl-4 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            or advertisements and other content served by or on behalf of Site
            on other web sites. (OS type and version, App version, device brand,
            browser and its version details, user agent) to see examples of the
            information we receive. We may also receive/store information about
            ...
            information and SPDI requires your express consent. You are
            providing us with your consent for our use, collection and
            disclosure of the personal information and SPDI. You may choose to
            not provide us with personal information or SPDI or if you ask us to
            delete your personal information or account, we may no longer be
            able to provide all or any of our Services to you., but in the event
            that you do so, we will be unable to provide you access to the
            Platform or provide Services.
          </p>
        </div>
        <br />
        <br />
        ...
        <p className="font-sophiaPro text-[17px] pl-8">
          ...
          or you provide, as described in this Privacy Policy, in the following
          ways:
        </p>
        <br />
        ...
        <div className="flex pl-12">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            whom we use to support our business (e.g. logistics and delivery, to
            collect payments), or to improve your experience on the Platform and
        ...
        <div className="pl-10 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            providers to provide the services, may also collect your personal
            information or SPDI during the process of providing such services.
            It is clarified that we will not be responsible and liable for the
            acts of omissions and commissions of such third parties associated
            with us. However, we may facilitate resolving any issue you may face
        ...
        <div className="pl-10 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            information to investigate and address threats or potential threats
            to the physical safety of any person, to investigate and address
            violations of this Privacy Policy or the Terms, or to investigate
            and address violations of the rights of third parties and/or to
        ...
        <div className="pl-10 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            interactions with social media companies are governed by their
            privacy policies.
          </p>
        </div>
        <br />
        ...
        <p className="font-sophiaPro text-[17px] pl-7">
          ...
          standards. We restrict access to personal information, to our
          ...
          service or telephone service of the user, etc. We implement
        ...
        <div className="pl-10 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            Platform for the limited purpose of viewing. You may rectify any
            inaccurate or deficient personal information or SPDI, or permanently
            delete your account, as feasible by contacting at the email address
            provided in the ‘Contact Us’ section. You have the option to opt-out
            of optional services such as receiving promotional materials etc.
            and should you desire to opt-in to such services at the time of
            signing up you may choose do so.
          </p>
        </div>
        <br />
        <div className="pl-10 flex">
        ...
        <div className="pl-10 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            details indicated in the contact section. Please note however that
            your withdrawal of consent or cancellation of account may result in
            us not being able to provide you access to our Services, or the
            Platform, or terminate any existing relationship that we may have
            with You.
          </p>
        </div>
        <br />
        ...
        <div className="pl-10 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            such Third Party Links available on the Platform, which are provided
            by persons or entities other than Us. You acknowledge and agree that
            we are not responsible for any collection or disclosure of your
            information by any external sites, applications, entities or persons
            thereof. The presence of any Third Party Links on the Platform,
            cannot be construed as a recommendation, endorsement or solicitation
            for the same, or any other material on or available via such Third
            Party Links.
          </p>
        </div>
        <br />
        <div className="pl-10 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            aforementioned third parties. Such third party websites, external
            applications or resources, accessible via the Third Party Links may
            have their own privacy policies governing the collection, storage,
            retention and disclosure of your information that you may be subject
            to. We recommend that you exercise reasonable diligence, as you
        ...
        <p className="font-sophiaPro text-[17px] pl-7">
          ...
          periodically for changes. Use of information we collect now is subject
          to the Privacy Policy in effect at the time such information is used.
          If we make changes in the way we collect or use your personal
          information, we will notify you by posting an announcement on the
          Platform or sending you an email. Please review the changes carefully.
          Your continued use of the Services or the Platform, following the
        ...
        <p className="font-sophiaPro text-[17px] pl-7">
          ...
          Services at any time or in any manner. If we learn that a person under
          18 years of age has used or accessed the Platform or Service or any
          personally identifiable information has been collected on the Platform
          from persons under 18 years of age, then we will take the appropriate
        ...
        <p className="font-sophiaPro text-[17px] pl-7">
          ...
          information provided above under section 11 of this Privacy Policy.
        </p>
        <br />
        <br />
        <div className="flex">
        ...
        <div className="pl-10 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            parties. We assume no liability for any actions of third parties
            with regard to your personal information or SPDI which you may have
        ...
        <div className="pl-10 flex">
          ...
          <p className="font-sophiaPro text-[17px]">
            ...
            or indicated by the context of the Privacy Policy. The decision or
