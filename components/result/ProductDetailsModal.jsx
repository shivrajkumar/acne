...
const ProductPageModal = ({ variantId, handleCancel, open }) => {
  ...
  return (
    ...
    >
      ...
      {isLoading ? (
      ...
      ) : error ? <div className="w-full mx-auto p-4 md:p-[10px] bg-white font-sophiaPro">
        <ProductErrorState
          error={error}
          onRetry={handleRetry}
          onCancel={handleCancel}
        ...
        !product || !product.content ? <div className="w-full mx-auto p-4 md:p-[10px] bg-white font-sophiaPro">
