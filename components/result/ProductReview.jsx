            ...
            >
              ...
              {(review?.review_heading ||
                ...
                <div>
                  ...
                  {review.review_about && (
                    <p
                      className={`text-[12px] font-[400] leading-[130%] text-Text/Disabled ${
                        review.review_heading ? "pt-1" : ""
                      } ${review.review_text ? "pb-1" : ""}`}
                    >
                      {review.review_about}
                    </p>
                  )}
                  ...
                  {review.review_text && (
                    <p
                      className={`text-[14px] font-[400] leading-[130%] text-primary/700 ${
                        review.review_about ? "pt-2" : ""
                      } pb-4`}
                    >
                      {review.review_text}
                    </p>
