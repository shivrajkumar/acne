  ...
  return (
    <div className="flex flex-col w-full">
      <div className="relative h-[400px] overflow-hidden w-full flex flex-col justify-start">
        {/* 🟡 Badge */}
        <div className="absolute top-2 right-0 z-10 bg-[#FFF88A] text-black text-sm font-medium px-3 py-1 block md:hidden">
          ACNE CARE
        </div>
          ...
          >
            <div className="flex justify-center items-center w-full mx-auto relative">
              <Image
                ...
                className="object-cover w-[300px] ml-8 md:ml-12 mt-10 md:mt-0"
